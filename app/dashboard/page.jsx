      ...
      <main className="main-content">
        ...
        <div className="overview-cards stagger-group" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '16px' }}>
          {loadingStats ? (
            ...
            <>
              <MagneticCard className="glass ov-card hover-lift" style={{ '--i': 1, position: 'relative' }}>
                <div title="Average score based on security, architecture, performance, and best practices." style={{ position: 'absolute', top: '16px', right: '16px', color: 'var(--text-muted)', cursor: 'help' }}>
                  <Info size={16} />
                </div>
              ...
              <MagneticCard className="glass ov-card hover-lift" style={{ '--i': 2, position: 'relative' }}>
                <div title="Measures the presence of vulnerabilities, hardcoded secrets, and unsafe dependencies." style={{ position: 'absolute', top: '16px', right: '16px', color: 'var(--text-muted)', cursor: 'help' }}>
                  <Info size={16} />
                </div>
              ...
              <MagneticCard className="glass ov-card hover-lift" style={{ '--i': 3, position: 'relative' }}>
                <div title="Evaluates code modularity, separation of concerns, and system design patterns." style={{ position: 'absolute', top: '16px', right: '16px', color: 'var(--text-muted)', cursor: 'help' }}>
                  <Info size={16} />
                </div>
              ...
              <MagneticCard className="glass ov-card hover-lift" style={{ '--i': 4, position: 'relative' }}>
                <div title="Detects low-effort, generic code and leftover debug logs commonly generated by AI." style={{ position: 'absolute', top: '16px', right: '16px', color: 'var(--text-muted)', cursor: 'help' }}>
                  <Info size={16} />
                </div>
